...
Input:   	data/SemEval/all_semeval_data.pkl
			...
			data/yelp/dataframes/review_sentences_WI.pkl
			data/yelp/dataframes/review_sentences_PA.pkl (Pandas dataframes)
...
review_corpus = add_to_corpus(review_corpus, "data/SemEval/all_semeval_data.pkl")
review_corpus = add_to_corpus(review_corpus, "data/yelp/dataframes/review_sentences_WI.pkl")
review_corpus = add_to_corpus(review_corpus, "data/yelp/dataframes/review_sentences_PA.pkl")
review_corpus = add_to_corpus(review_corpus, "data/yelp/dataframes/review_sentences_Carolina.pkl")
